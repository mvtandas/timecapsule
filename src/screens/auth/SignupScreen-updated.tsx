      ...
      >
        ...
        <View style={styles.header}>
          <View style={styles.iconContainer}>
            <MaterialIcons name="person-add" size={64} color="#00C9FF" />
          </View>
        ...
        <View style={styles.formContainer}>
          ...
          <View style={styles.inputContainer}>
            <MaterialIcons name="alternate-email" size={24} color="#AAAAAA" style={styles.inputIcon} />
            <TextInput
              value={username}
          ...
          <View style={styles.inputContainer}>
            <MaterialIcons name="email" size={24} color="#AAAAAA" style={styles.inputIcon} />
            <TextInput
              value={email}
